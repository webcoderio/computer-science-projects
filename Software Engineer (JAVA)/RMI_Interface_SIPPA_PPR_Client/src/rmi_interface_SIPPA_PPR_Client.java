...
//	               option: 0 is always the case due to the PPR software
	...
	public void invoke_SIPPA_PPR_Client (String transaction_ID, String rmi_client_ip_of_SIPPA_server, int SIPPA_Server_socket_port, int option, int userDefinedRowSize, int userDefinedColumnSize, String optionHelperData, String rmi_server_ip_of_SIPPA_client) throws RemoteException;
