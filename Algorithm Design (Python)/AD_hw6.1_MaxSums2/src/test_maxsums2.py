...
from maxsums2 import maxsums_dc
import unittest
import time
...
class TestMaxsums(unittest.TestCase):
    ...
    def test1(self):
        ...
        ans = maxsums_dc([-1,3,2,-7,4,2,-2,3,-1])
        self.assertEqual(ans, 7)

        ans = maxsums_dc([-1,4,-1,3])
    ...
    def test2(self):
        ...
        ans = maxsums_dc([1]*1000)
        self.assertEqual(ans, 1000)

        ans = maxsums_dc([-2,1]*1000)
    ...
    def test3(self):
        ...
        ans = maxsums_dc([1]*2000)
        self.assertEqual(ans, 2000)

        ans = maxsums_dc([-2,1]*2000)
        self.assertEqual(ans, 1)
